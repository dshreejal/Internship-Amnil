 ...
 */
    logger.error(`Request Terminated : ${req.method} ${req.originalUrl}  | Query Params:  ${JSON.stringify(req.query)} | Error Code: ${error.status || HttpStatus.INTERNAL_SERVER_ERROR} | Error Message: ${error.message} |`);
